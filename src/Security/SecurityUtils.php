...
class SecurityUtils
{
     ...
     * @return string The generated byte string.
     */
    ...
    /**
     * Escapes a string for safe use in SQL queries, preventing SQL injection.
     * 
     ...
     * @param int $expiry The expiration time of the token in seconds (default is 3600 seconds).
